...
class ShoutcastUpdater 
{
  ...
  {    
    try
    {
        //Replace the weird seperator. The URL encoding is a gross but working way to find the seperator character
        ...
        title = "";
        //Check for the title duplication bug (also rebuild the string)
